...
fn define_string<'a>(cache: &mut ModuleCache<'a>) -> Type {
    ...
    let ptr_type = Type::Primitive(PrimitiveType::PtrType);
    ...
    let constructor_type = Type::Function(FunctionType {
        parameters: vec![c_string_type.clone(), length_type.clone()],
